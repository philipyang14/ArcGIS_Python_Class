...
def describe_shp(input_shapefile):
    ...
    print(f"\n Shapetype: {shapetype}\n Spatial reference name: {sprefname}\n Spatial reference type: {spreftype} ")
    return shapetype, sprefname, spreftype


# Task 2 - Run your function on the RI_Roads.shp dataset, use only 1 line of code.

describe_shp(r"C:\Users\Philip Yang\OneDrive - University of Rhode Island\NRS_528\ArcGIS_Python_Class\Class_8_Functions\Step_5_Data\Places.shp")