...
take the depth values from a raster (using a 50 m bathymetry grid for Flower Garden Banks) and appended to the attribute table as a new field in the points shapefile. Tools 3 (Habitat_DataCleaning) and 4 (DeleteFolder) deal with cleaning the point shapefile to 
